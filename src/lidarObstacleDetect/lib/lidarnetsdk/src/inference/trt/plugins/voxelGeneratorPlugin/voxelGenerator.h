...
#ifndef LIB_INFERENCE_TRT_PLUGINS_VOXELGENERATORPLUGIN_VOXELGENERATOR
#define LIB_INFERENCE_TRT_PLUGINS_VOXELGENERATORPLUGIN_VOXELGENERATOR
...
class VoxelGeneratorPlugin : public nvinfer1::IPluginV2DynamicExt {
   public:
    ...
    VoxelGeneratorPlugin(int max_voxels, int max_points, int voxel_features, float x_min, float x_max, float y_min,
                         float y_max, float z_min, float z_max, float pillar_x, float pillar_y, float pillar_z);
    VoxelGeneratorPlugin(int max_voxels, int max_points, int voxel_features, float x_min, float x_max, float y_min,
                         float y_max, float z_min, float z_max, float pillar_x, float pillar_y, float pillar_z,
                         int point_features, int grid_x, int grid_y, int grid_z);
...
#endif /* LIB_INFERENCE_TRT_PLUGINS_VOXELGENERATORPLUGIN_VOXELGENERATOR */
