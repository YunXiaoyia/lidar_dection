 ...
 */
#ifndef LIB_INFERENCE_TRT_PLUGINS_SCATTERPLUGIN_SCATTERPLUGIN
#define LIB_INFERENCE_TRT_PLUGINS_SCATTERPLUGIN_SCATTERPLUGIN
...
#endif /* LIB_INFERENCE_TRT_PLUGINS_SCATTERPLUGIN_SCATTERPLUGIN */
