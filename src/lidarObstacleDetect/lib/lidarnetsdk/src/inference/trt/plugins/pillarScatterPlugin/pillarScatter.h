...
#ifndef LIB_INFERENCE_TRT_PLUGINS_PILLARSCATTER_PILLARSCATTER
#define LIB_INFERENCE_TRT_PLUGINS_PILLARSCATTER_PILLARSCATTER
...
#endif /* LIB_INFERENCE_TRT_PLUGINS_PILLARSCATTER_PILLARSCATTER */
