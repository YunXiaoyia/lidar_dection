...
const int PILLARS_PER_BLOCK = 32;
const int PILLAR_FEATURE_SIZE = 192;

template <typename Element>
__global__ void scatterBEV_kernel(const Element *pillar_features_data, const unsigned int *coords_data,
...
template int pillarScatterKernelLaunch<half>(int batch_size, int max_pillar_num, int num_features,
...
template int pillarScatterKernelLaunch<float>(int batch_size, int max_pillar_num, int num_features,
                                              const float *pillar_features_data, const unsigned int *coords_data,
                                              const unsigned int *params_data, unsigned int featureX,
                                              unsigned int featureY, float *spatial_feature_data, cudaStream_t stream);