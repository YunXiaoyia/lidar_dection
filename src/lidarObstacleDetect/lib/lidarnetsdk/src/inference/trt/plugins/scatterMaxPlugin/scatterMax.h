#ifndef LIB_INFERENCE_TRT_PLUGINS_SCATTERMAX_SCATTERPLUGIN
#define LIB_INFERENCE_TRT_PLUGINS_SCATTERMAX_SCATTERPLUGIN
...
class ScatterMax : public IPluginV2DynamicExt {
   public:
    ScatterMax() = delete;
    ScatterMax(const void* data, size_t length);
    ScatterMax(size_t num);
    ~ScatterMax() override = default;
