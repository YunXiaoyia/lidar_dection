...
#ifndef LIB_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_TRT_GRID_SAMPLER
#define LIB_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_TRT_GRID_SAMPLER
#include <cublas_v2.h>
...
#endif /* LIB_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_TRT_GRID_SAMPLER */
