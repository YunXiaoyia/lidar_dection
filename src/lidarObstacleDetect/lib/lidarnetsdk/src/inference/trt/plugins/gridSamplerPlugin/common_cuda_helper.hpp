...
#ifndef SRC_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_COMMON_CUDA_HELPER
#define SRC_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_COMMON_CUDA_HELPER
...
cublasStatus_t cublasGemmWrap(cublasHandle_t handle, cublasOperation_t transa, cublasOperation_t transb, int m, int n,
                              int k, const scalar_t* alpha, const scalar_t* A, int lda, const scalar_t* B, int ldb,
                              const scalar_t* beta, scalar_t* C, int ldc);

template <typename scalar_t>
__device__ __forceinline__ scalar_t bilinear_interpolate(const scalar_t* __restrict__ input, const int height,
...
#endif /* SRC_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_COMMON_CUDA_HELPER */
