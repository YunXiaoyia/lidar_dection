...
#ifndef LIB_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_TRT_SERIALIZE
#define LIB_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_TRT_SERIALIZE
#include <cassert>
#include <cstring>
#include <type_traits>
#include <vector>
...
#endif /* LIB_INFERENCE_TRT_PLUGINS_GRIDSAMPLERPLUGIN_TRT_SERIALIZE */
