...
// float getRotatedIOU(const perception::BoundingBox& bbox1_raw, const perception::BoundingBox& bbox2_raw) {
//     const auto area1 = bbox1_raw.extent(0) * bbox1_raw.extent(1);
//     const auto area2 = bbox2_raw.extent(0) * bbox2_raw.extent(1);
